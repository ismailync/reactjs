    ...
    <div className='max-w-[1520px] m-auto py-12 px-4'>
        ...
        <div className='flex flex-col lg:flex-row justify-center'>
            <div className='flex justify-center md:justify-center'>
                ...
                className='m-1 border-orange-700 text-white bg-orange-700 hover:bg-white hover:text-orange-700 hover:border-orange-700'>Sald</button>
            </div>
        </div>
                ...
                foods.map((item)=>(
                    <div key={item.id} className='border-none hover:scale-105 duration-300'>
                        ...
                        <div className='flex justify-between py-2 px-2'>
                            ...
                            <p className='bg-orange-700 rounded-full text-white -mt-10 py-4 px-2 border-8 font-bold'>{item.price}</p>
                        </div>

                        <div className='pl-2 py-4 -mt-7'>
                            <p className='flex items-center text-blue-700'>View More<ArrowSmRightIcon className='w-5 ml-2'/></p>
                        </div>
